...
public class Player : MonoBehaviour {
	...
	public static void DisplayInteractions(string title, ICollection<Interaction> interactions) {
		...
		ButtonsFrame frame = Instantiate(GameController.PrefabManager.buttonsFramePrefab, canvasTransform);
		...
		foreach (Interaction interaction in interactions) {
			Button button = Instantiate(GameController.PrefabManager.buttonPrefab, parent);

...
namespace UnityEditor.PostProcessing
{
    ...
    public class HistogramMonitor : PostProcessingMonitor
    {
        ...
        void ComputeHistogram(RenderTexture source)
        {
            ...
            {
                case PostProcessingProfile.MonitorSettings.HistogramMode.Red: channels.x = 1f; break;
                case PostProcessingProfile.MonitorSettings.HistogramMode.Green: channels.y = 1f; break;
                case PostProcessingProfile.MonitorSettings.HistogramMode.Blue: channels.z = 1f; break;
                case PostProcessingProfile.MonitorSettings.HistogramMode.Luminance: channels.w = 1f; break;

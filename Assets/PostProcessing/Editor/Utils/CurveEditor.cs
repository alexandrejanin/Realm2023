...
namespace UnityEditor.PostProcessing
{
    public sealed class CurveEditor
    {
        ...
        Vector3 CurveToCanvas(Keyframe keyframe) => CurveToCanvas(new Vector3(keyframe.time, keyframe.value));
        ...
        float ProjectTangent(float inPosition, float inValue, float inTangent, float projPosition) => inValue + ((projPosition - inPosition) * inTangent);

...
namespace UnityEngine.PostProcessing
{
    ...
    public sealed class AmbientOcclusionComponent : PostProcessingComponentCommandBuffer<AmbientOcclusionModel>
    {
        ...
        bool ambientOnlySupported => context.isHdr && model.settings.ambientOnly && context.isGBufferAvailable && !model.settings.forceForwardCompatibility;
        ...
        public override CameraEvent GetCameraEvent() => ambientOnlySupported && !context.profile.debugViews.IsModeActive(DebugMode.AmbientOcclusion)

namespace UnityEngine.PostProcessing
{
    ...
    public sealed class ColorGradingComponent : PostProcessingComponentRenderTexture<ColorGradingModel>
    {
        ...
        float StandardIlluminantY(float x) => 2.87f * x - 3f * x * x - 0.27509507f;
        ...
        static Vector3 ClampVector(Vector3 v, float min, float max) => new Vector3(
        ...
        bool IsLogLutValid(RenderTexture lut) => lut != null && lut.IsCreated() && lut.height == k_InternalLogLutSize;
